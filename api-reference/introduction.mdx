...
```
Production: https://mcp-backend-[hash].me-central2.run.app
Local: http://localhost:8080
```

## Authentication

The Sari API supports two authentication methods:

<CardGroup cols={2}>
  <Card title="Firebase Token" icon="fire">
    For Admin Console and web users
    ```
    Authorization: Bearer <firebase_id_token>
    ```
  </Card>
  <Card title="API Key" icon="key">
    For AI agents and MCP Server
    ```
